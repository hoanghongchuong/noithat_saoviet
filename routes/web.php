...
Route::get('ho-so-nang-luc','IndexController@hoso');
Route::get('phan-phoi-son-nuoc','IndexController@phanphoi');
Route::get('phan-phoi/{alias}.html','IndexController@phanphoiDetail');
Route::get('thi-cong','IndexController@thicong');
Route::get('thi-cong/{alias}.html','IndexController@thicongDetail');
